  ...
  return (
    <footer className="footer">
      ...
      <div className="container footer_bottom">
        <div className="icons">
          <a href="https://www.facebook.com/profile.php?id=100094026783106">
            <FaFacebookF
              className="facebook"
              width={style.width}
              height={style.height}
          ...
          <a href="https://www.youtube.com/@Bearpartner">
            {" "}
            <FaYoutube className="youtube" style={{ ...style }} />
          </a>
          <a href="https://www.instagram.com/bear_partner/">
            <BsInstagram className="instagram" style={{ ...style }} />
          </a>
          <a href="https://t.me/Bearpartner">
